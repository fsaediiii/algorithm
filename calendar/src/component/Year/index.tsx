import { FC, memo, MutableRefObject, PropsWithChildren, useEffect, useRef, useState } from "react";
...
const Years: FC<PropsWithChildren<IYearComponent>> = ({ year, changeEvent }): JSX.Element => {
  ...
  const yearChanged = () => {
    ...
    if (value.length === 4 && value > 1300 && value < 1500) changeEvent?.(parseInt(value));
    // else
    // setYear((prevState) => ({
    //     ...prevState,
